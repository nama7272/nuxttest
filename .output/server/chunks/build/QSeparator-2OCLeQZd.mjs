import { getCurrentInstance, ref, computed, h, Transition, withDirectives } from 'vue';
import { e as createComponent, s as stopAndPrevent, l as listenOpts, p as prevent, j as stop, q as createDirective } from './server.mjs';
  ...
  setup(props, { slots, emit }) {
    ...
    function onClick(e) {
      ...
      if (e !== void 0) {
        ...
        if (props.type === "submit" && el !== (void 0).body && rootRef.value.contains(el) === false && el.contains(rootRef.value) === false) {
          e.qAvoidFocus !== true && rootRef.value.focus();
          const onClickCleanup = () => {
            var _a;
            (void 0).removeEventListener("keydown", stopAndPrevent, true);
            (void 0).removeEventListener("keyup", onClickCleanup, passiveCapture);
            (_a = rootRef.value) == null ? void 0 : _a.removeEventListener("blur", onClickCleanup, passiveCapture);
          };
          (void 0).addEventListener("keydown", stopAndPrevent, true);
          (void 0).addEventListener("keyup", onClickCleanup, passiveCapture);
    ...
    function onKeydown(e) {
      ...
      if (isKeyCode(e, [13, 32]) === true && keyboardTarget !== rootRef.value) {
        ...
        if (e.defaultPrevented !== true) {
          ...
          (void 0).addEventListener("keyup", onPressEnd, true);
    ...
    function onMousedown(e) {
      ...
      if (e.defaultPrevented !== true && mouseTarget !== rootRef.value) {
        ...
        rootRef.value.classList.add("q-btn--active");
        (void 0).addEventListener("mouseup", onPressEnd, passiveCapture);
      }
    }
    function onPressEnd(e) {
      if (rootRef.value === null) return;
      if ((e == null ? void 0 : e.type) === "blur" && (void 0).activeElement === rootRef.value) return;
    ...
    function cleanup(destroying) {
      ...
      if ((touchTarget === rootRef.value || mouseTarget === rootRef.value) && blurTarget !== null && blurTarget !== (void 0).activeElement) {
      ...
      if (mouseTarget === rootRef.value) {
        (void 0).removeEventListener("mouseup", onPressEnd, passiveCapture);
        mouseTarget = null;
      }
      if (keyboardTarget === rootRef.value) {
        (void 0).removeEventListener("keyup", onPressEnd, true);
...
export { QSpinner as Q, __nuxt_component_1 as _, __nuxt_component_2$1 as a, __nuxt_component_2 as b, __nuxt_component_3 as c, __nuxt_component_5 as d, useDark as e, useRouterLinkProps as f, useRouterLink as g, hSlot as h, isKeyCode as i, hUniqueSlot as j, useAlignProps as k, useAlign as l, shouldIgnoreKey as s, useDarkProps as u, vmIsDestroyed as v };
//# sourceMappingURL=QSeparator-2OCLeQZd.mjs.map

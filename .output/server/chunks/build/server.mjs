import { markRaw, defineComponent, hasInjectionContext, inject, getCurrentInstance, ref, watchEffect, watch, unref, version, h, computed, provide, shallowReactive, Suspense, Fragment, createApp, toRef, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, mergeProps, getCurrentScope, withCtx, nextTick, useSSRContext } from 'vue';
import { e as createError$1, l as hasProtocol, m as isScriptProtocol, n as joinURL, w as withQuery, o as sanitizeStatusCode, p as getContext, $ as $fetch, q as createHooks, v as defuFn, x as toRouteMatcher, y as createRouter$1, z as defu, A as klona } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-DaEfZ5qK.mjs')
  },
  {
    name: "miyavi",
    path: "/miyavi",
    component: () => import('./miyavi-B5h02bEf.mjs')
  },
  {
    name: "user-id",
    path: "/user/:id()",
    component: () => import('./_id_-DoI3k0Nx.mjs')
  },
  {
    name: "user",
    path: "/user",
    component: () => import('./index-DO0U7GqD.mjs')
  }
];
...
const createReactivePlugin = (state, plugin2) => {
  Object.assign(plugin2, state);
  return plugin2;
};
const listenOpts = {
  hasPassive: false,
...
const Plugin$1 = createReactivePlugin({
  ...
  set(langObject = lang, ssrContext) {
    ...
    };
    {
      ...
      lang2.set = ssrContext.$q.lang.set;
      if (ssrContext.$q.config.lang === void 0 || ssrContext.$q.config.lang.noHtmlAttrs !== true) {
        const dir = lang2.rtl === true ? "rtl" : "ltr";
        const attrs = `lang=${lang2.isoName} dir=${dir}`;
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BkWUZJdP.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Bf8Qh2Og.mjs'));
...
export { _export_sfc as _, useNuxtApp as a, useRuntimeConfig as b, nuxtLinkDefaults as c, useHead as d, entry$1 as default, createComponent as e, useRoute as f, formKey as g, client as h, isRuntimeSsrPreHydration as i, stop as j, asyncDataDefaults as k, listenOpts as l, createError as m, navigateTo as n, fetchDefaults as o, prevent as p, createDirective as q, resolveRouteObject as r, stopAndPrevent as s, useRouter as u };
